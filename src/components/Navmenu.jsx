...
const components = [
  {
    title: "Home",
    href: "/",
    description: "A summary of my self.",
  },
  {
    title: "About-me",
    href: "/about-me",
    description: "Read more about me, my hobies, skills and tools i use.",
  },
  {
    title: "Projects",
    href: "/projects",
    description: "Look at projects and simple projects, i have done yet.",
  },
  {
    title: "Contact",
    href: "/contact",
    description: "Get in touch with me, perhaps support me if you wish",
  },
...
export function NavMenu() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger>Design tools</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Get in</NavigationMenuTrigger>
          <NavigationMenuContent>
